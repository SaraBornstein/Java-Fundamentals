...
public class BlackjackController {
    ...
    public void playBlackJack() {
        ...
        while (play) {
            ...
            while (userBet > userPlayer.getPotValue()) {
                System.out.print("Please enter a bet less than your current pot value: ");
            ...
            while (userPlayer.getHand().greaterThan21() == false && computerPlayer.getHand().greaterThan21() == false) {
                ...
                if (userHitMe) {
                    ...
                    System.out.println(userPlayer.getName() + ", " + userPlayer.getHand().toString()); //user did not take new card, print hand again
                }
                if (computerPlayer.computerAI(computerPlayer)) {
                    deck.deal(computerPlayer); //deal computer new card
                ...
                //System.out.println(userPlayer.getName() + ", your pot value is $" + userPlayer.getPotValue());
                //System.out.println("The computer's pot vlaue is $" + computerPlayer.getPotValue());
                if (userPlayer.getPotValue() <= 0) {
                    System.out.println("GAME OVER");
                    return;
                }
            }//while the user and computer hands are less than 21
