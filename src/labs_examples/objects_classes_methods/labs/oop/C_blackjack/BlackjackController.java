 ...
 */
        ...
        System.out.println(userPlayer.getName() + ", " + userPlayer.getHand().toString() + ", your pot value is $" + userPlayer.getPotValue());
        System.out.println("The Computer's hand value is " + computerPlayer.getHand().getHandValue() + " and pot value is $" + computerPlayer.getPotValue());
        ...
        if(computerPlayer.getHand().getHandValue() < userPlayer.getHand().getScore() && userPlayer.getHand().getScore() <= 21 || computerPlayer.getHand().getHandValue() > 21){
            System.out.println(userPlayer.getName() + ", you win!");
            userWin++;
            totalGamesPlayed++;
        } else{
